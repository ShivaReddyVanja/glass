      ...
      case 'profile':
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 flex justify-between">
              <div>
              ...
              {loading ? (
                ...
                <>
                  <p className="text-gray-700 text-sm mb-2">{role || 'No role selected'}</p>
              ...
              <button
                onClick={() => router.push('/role-selection')}
                 className="px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 disabled:opacity-50 h-fit"
              >
                Update
              </button>
            </div>
